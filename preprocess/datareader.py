...
class Datareader:
    ...
    def read_data(self):
        ...
        A_user_dict = {}
        filePath_A = 'data/raw/' + self.dataName_A + '.json'
        ...
        B_user_dict = {}
        filePath_B = 'data/raw/' + self.dataName_B + '.json'
        ...
        temp_keys = list(A_user_dict.keys())
        for user in tqdm(temp_keys):
            if user not in B_user_dict.keys():
                A_user_dict.pop(user)

        temp_keys = list(B_user_dict.keys())
        for user in tqdm(temp_keys):
            if user not in A_user_dict.keys():
                B_user_dict.pop(user)
        ...
        print(len(self.A_user_review_dict))
        print(len(self.B_user_review_dict))
